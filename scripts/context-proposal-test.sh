...
capsule = {
    ...
    "acceptance": [
        ...
        "Preserve the local completion helper files."
    ],
    "risks": [],
    "notes": ["Generated by the primary-agent handoff step triggered from /cook."],
    "handoff_kind": "implementation_workflow_handoff",
...
assert proposal['analysis']['workflowRelation'] == 'replace_current_workflow', 'active inline prompt should persist explicit replacement workflow_relation in the proposal snapshot'
assert proposal['analysis']['confidence'] == 'high', 'active inline prompt should persist explicit replacement confidence in the proposal snapshot'
